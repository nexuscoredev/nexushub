      ...
      <section className={styles.overview} aria-label="Resumo das contas fixas">
        ...
        <div className={styles.kpiGrid}>
          <article className={styles.kpiCard}>
            <img src="/img/personal/grupo-fixos.svg" alt="" className={styles.kpiIcon} aria-hidden />
            <div className={styles.kpiBody}>
              <span className={styles.kpiLabel}>Fixos</span>
              <strong className={styles.kpiValue}>{formatBRL(summary.fixos)}</strong>
            </div>
          </article>
          <article className={styles.kpiCard}>
            <img src="/img/personal/grupo-variaveis.svg" alt="" className={styles.kpiIcon} aria-hidden />
            <div className={styles.kpiBody}>
              <span className={styles.kpiLabel}>Variáveis</span>
              <strong className={styles.kpiValue}>{formatBRL(summary.variaveis)}</strong>
            </div>
          </article>
          <article className={`${styles.kpiCard} ${styles.kpiPaid}`}>
            <img src="/img/finance/recebido.svg" alt="" className={styles.kpiIcon} aria-hidden />
            <div className={styles.kpiBody}>
              <span className={styles.kpiLabel}>Pago</span>
              <strong className={styles.kpiValue}>{formatBRL(summary.valorPago)}</strong>
            </div>
          </article>
          <article className={`${styles.kpiCard} ${styles.kpiDue}`}>
            <img src="/img/finance/pendente.svg" alt="" className={styles.kpiIcon} aria-hidden />
            <div className={styles.kpiBody}>
              <span className={styles.kpiLabel}>A pagar</span>
              <strong className={styles.kpiValue}>{formatBRL(summary.valorAPagar)}</strong>
            </div>
          </article>
        </div>
      </section>
