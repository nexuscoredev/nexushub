export const LIGEIRINHO_SITE_URL = 'https://ligeirinhobebidas.vercel.app/';
export const LIGEIRINHO_STATUS_DATE = '09 de junho de 2026';

export const LIGEIRINHO_SUMMARY =
  'O Ligeirinho saiu de um site simples para um app de pedidos completo, com login, nova marca Parceiros, pagamento online e registro de pedidos — pronto para uso, com melhorias contínuas em andamento.';

export type DeliveryStatus = 'done' | 'paused';
...
export const LIGEIRINHO_CLIENT_FLOW = [
